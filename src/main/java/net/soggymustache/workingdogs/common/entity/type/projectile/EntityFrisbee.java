package net.soggymustache.workingdogs.common.entity.type.projectile;
...
public class EntityFrisbee extends Entity implements IProjectile {
	...
	private static final DataParameter<Byte> CRITICAL = EntityDataManager.<Byte>createKey(EntityFrisbee.class, DataSerializers.BYTE);
	private int xTile;
	private int yTile;
	private int zTile;
	...
	public EntityFrisbee(World worldIn, double x, double y, double z) {
		this(worldIn);
		this.setPosition(x, y, z);
	}

	public EntityFrisbee(World worldIn, EntityLivingBase shooter) {
...
/*			int j = block.getMetaFromState(iblockstate);
	...
	protected ItemStack getArrowStack(){
		return new ItemStack(DogItems.FRISBEE);
	}
