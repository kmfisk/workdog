...
public class WorkDogEntities {
    ...
    public static final EntityType<WDWolfEntity> WOLF = register("wolf", WDWolfEntity::new, EntityClassification.CREATURE,
            WDWolfEntity::registerAttributes, () -> WDWolfRenderer::new, 0.95F, 1.2F);
    public static final EntityType<AkitaEntity> AKITA = register("akita", AkitaEntity::new, EntityClassification.CREATURE,
            AkitaEntity::registerAttributes, () -> AkitaRenderer::new, 0.95F, 1.3F);
    public static final EntityType<BorderCollieEntity> BORDER_COLLIE = register("border_collie", BorderCollieEntity::new, EntityClassification.CREATURE,
            BorderCollieEntity::registerAttributes, () -> BorderCollieRenderer::new, 0.75F, 1.2F);
    public static final EntityType<BostonTerrierEntity> BOSTON_TERRIER = register("boston_terrier", BostonTerrierEntity::new, EntityClassification.CREATURE,
            BostonTerrierEntity::registerAttributes, () -> BostonTerrierRenderer::new, 0.55F, 0.95F);
    public static final EntityType<GermanShepherdEntity> GERMAN_SHEPHERD = register("german_shepherd", GermanShepherdEntity::new, EntityClassification.CREATURE,
            GermanShepherdEntity::registerAttributes, () -> GermanShepherdRenderer::new, 0.95F, 1.3F);
    public static final EntityType<JackRussellTerrierEntity> JACK_RUSSELL_TERRIER = register("jack_russell_terrier", JackRussellTerrierEntity::new, EntityClassification.CREATURE,
            JackRussellTerrierEntity::registerAttributes, () -> JackRussellTerrierRenderer::new, 0.55F, 0.95F);
    public static final EntityType<PitBullEntity> PIT_BULL = register("pit_bull", PitBullEntity::new, EntityClassification.CREATURE,
