...
public abstract class BorderCollieModel extends WorkDogModel<BorderCollieEntity> {
    public static ModelLayerLocation ADULT_LAYER = new ModelLayerLocation(new ResourceLocation(WorkDog.MOD_ID, "border_collie"), "adult");
    public static ModelLayerLocation EQUIPMENT_LAYER = new ModelLayerLocation(new ResourceLocation(WorkDog.MOD_ID, "border_collie"), "equipment");
    public static ModelLayerLocation BABY_LAYER = new ModelLayerLocation(new ResourceLocation(WorkDog.MOD_ID, "border_collie"), "baby");
    ...
    public static class Adult extends BorderCollieModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Chest = partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 0).addBox(-3.5F, -3.5F, -2.5F, 7, 7, 5), PartPose.offsetAndRotation(0.0F, 13.0F, -4.0F, -0.045553093477052F, 0.0F, 0.0F));
            PartDefinition ChestFur = Chest.addOrReplaceChild("ChestFur", CubeListBuilder.create().texOffs(13, 76).addBox(-2.5F, 0.0F, 0.0F, 5, 3, 4), PartPose.offsetAndRotation(0.0F, 3.3F, -2.5F, 0.31869712141416456F, 0.0F, 0.0F));
            PartDefinition Body = Chest.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 12).addBox(-3.0F, 0.0F, 0.0F, 6, 7, 7), PartPose.offsetAndRotation(0.0F, -3.5F, 1.9F, 0.045553093477052F, 0.0F, 0.0F));
            PartDefinition Hips = Body.addOrReplaceChild("Hips", CubeListBuilder.create().texOffs(0, 26).addBox(-3.5F, 0.0F, 0.0F, 7, 7, 4), PartPose.offsetAndRotation(0.0F, 0.0F, 7.0F, -0.136659280431156F, 0.0F, 0.0F));
            PartDefinition ThighLeft = Hips.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(28, 29).addBox(-2.0F, 0.0F, -2.0F, 4, 6, 4), PartPose.offsetAndRotation(1.9F, 1.7F, 1.9F, 0.18203784098300857F, 0.0F, 0.0F));
            PartDefinition UpperLegLeft = ThighLeft.addOrReplaceChild("UpperLegLeft", CubeListBuilder.create().texOffs(29, 39).addBox(-1.5F, 0.0F, 0.0F, 3, 4, 3), PartPose.offsetAndRotation(0.0F, 6.0F, -1.8F, 0.6373942428283291F, 0.0F, 0.0F));
            PartDefinition LowerLegLeft = UpperLegLeft.addOrReplaceChild("LowerLegLeft", CubeListBuilder.create().texOffs(32, 46).addBox(-1.0F, 0.0F, -2.0F, 2, 4, 2), PartPose.offsetAndRotation(0.0F, 4.0F, 2.7F, -0.6829473363053812F, 0.0F, 0.0F));
            PartDefinition FootLeft = LowerLegLeft.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(36, 52).addBox(-1.0F, -1.0F, -2.0F, 2, 2, 2), PartPose.offset(-0.1F, 4.0F, -0.9F));
            PartDefinition ThighRight = Hips.addOrReplaceChild("ThighRight", CubeListBuilder.create().texOffs(44, 29).mirror(true).addBox(-2.0F, 0.0F, -2.0F, 4, 6, 4), PartPose.offsetAndRotation(-1.9F, 1.7F, 1.9F, 0.18203784098300857F, 0.0F, 0.0F));
            PartDefinition UpperLegRight = ThighRight.addOrReplaceChild("UpperLegRight", CubeListBuilder.create().texOffs(46, 39).mirror(true).addBox(-1.5F, 0.0F, 0.0F, 3, 4, 3), PartPose.offsetAndRotation(0.0F, 6.0F, -1.8F, 0.6373942428283291F, 0.0F, 0.0F));
            PartDefinition LowerLegRight = UpperLegRight.addOrReplaceChild("LowerLegRight", CubeListBuilder.create().texOffs(48, 46).mirror(true).addBox(-1.0F, 0.0F, -2.0F, 2, 4, 2), PartPose.offsetAndRotation(0.0F, 4.0F, 2.7F, -0.6829473363053812F, 0.0F, 0.0F));
            PartDefinition FootRight = LowerLegRight.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(48, 52).mirror(true).addBox(-1.0F, -1.0F, -2.0F, 2, 2, 2), PartPose.offset(0.1F, 4.0F, -0.9F));
            PartDefinition Tail1 = Hips.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(49, 0).addBox(-1.0F, 0.0F, -1.0F, 2, 4, 2), PartPose.offsetAndRotation(0.0F, 1.5F, 3.5F, 1.2747884856566583F, 0.0F, 0.0F));
            PartDefinition TailFur1 = Tail1.addOrReplaceChild("TailFur1", CubeListBuilder.create().texOffs(44, 57).addBox(-2.0F, 0.0F, -3.0F, 4, 4, 4), PartPose.offset(0.0F, 0.0F, -1.4F));
            PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(49, 7).addBox(-1.0F, 0.0F, 0.0F, 2, 4, 2), PartPose.offsetAndRotation(0.0F, 4.0F, -1.0F, 0.27314402793711257F, 0.0F, 0.0F));
            PartDefinition TailFur2 = Tail2.addOrReplaceChild("TailFur2", CubeListBuilder.create().texOffs(44, 66).addBox(-1.5F, -1.0F, -2.5F, 3, 8, 4), PartPose.offset(0.0F, 0.0F, 0.2F));
            PartDefinition BellyFur = Body.addOrReplaceChild("BellyFur", CubeListBuilder.create().texOffs(17, 64).addBox(-2.5F, 0.0F, 0.0F, 5, 3, 8), PartPose.offsetAndRotation(0.0F, 6.6F, -1.0F, 0.18203784098300857F, 0.0F, 0.0F));
            PartDefinition Saddlebag = Body.addOrReplaceChild("Saddlebag", CubeListBuilder.create().texOffs(0, 87).addBox(-4.0F, -2.5F, -2.5F, 8, 5, 5), PartPose.offset(0.0F, 2.0F, 7.0F));
            PartDefinition SaddlebagLatchR = Saddlebag.addOrReplaceChild("SaddlebagLatchR", CubeListBuilder.create().texOffs(0, 88).addBox(-1.0F, 0.0F, -0.5F, 1, 2, 1), PartPose.offset(-3.4F, -2.0F, 0.0F));
            PartDefinition SaddlebagLatchL = Saddlebag.addOrReplaceChild("SaddlebagLatchL", CubeListBuilder.create().texOffs(0, 88).addBox(0.0F, 0.0F, -0.5F, 1, 2, 1), PartPose.offset(3.4F, -2.0F, 0.0F));
            PartDefinition HarnessHandle = Body.addOrReplaceChild("HarnessHandle", CubeListBuilder.create().texOffs(0, 81).addBox(-2.5F, 0.0F, 0.0F, 5, 3, 2), PartPose.offsetAndRotation(0.0F, -2.0F, 1.5F, -0.27314402793711257F, 0.0F, 0.0F));
            PartDefinition ArmBaseLeft = Chest.addOrReplaceChild("ArmBaseLeft", CubeListBuilder.create().texOffs(24, 0).addBox(-1.5F, 0.0F, -2.0F, 3, 4, 3), PartPose.offsetAndRotation(2.2F, 1.3F, 0.0F, 0.136659280431156F, 0.0F, 0.0F));
            PartDefinition ArmFurLeft = ArmBaseLeft.addOrReplaceChild("ArmFurLeft", CubeListBuilder.create().texOffs(26, 20).addBox(-1.5F, -1.0F, 0.0F, 3, 5, 3), PartPose.offsetAndRotation(-0.3F, 1.6F, -0.6F, 0.22759093446006054F, 0.0F, 0.0F));
            PartDefinition ArmLeft = ArmBaseLeft.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(27, 7).addBox(-1.0F, 0.0F, -2.0F, 2, 3, 2), PartPose.offsetAndRotation(0.0F, 3.8F, 0.5F, -0.045553093477052F, 0.0F, 0.0F));
            PartDefinition ForearmLeft = ArmLeft.addOrReplaceChild("ForearmLeft", CubeListBuilder.create().texOffs(28, 12).addBox(-1.0F, 0.0F, 0.0F, 2, 2, 2), PartPose.offsetAndRotation(-0.1F, 2.6F, -2.0F, -0.136659280431156F, 0.0F, 0.0F));
            PartDefinition HandLeft = ForearmLeft.addOrReplaceChild("HandLeft", CubeListBuilder.create().texOffs(28, 16).addBox(-1.0F, -1.0F, -3.0F, 2, 2, 2), PartPose.offsetAndRotation(-0.1F, 2.0F, 2.4F, 0.091106186954104F, 0.0F, 0.0F));
            PartDefinition ArmBaseRight = Chest.addOrReplaceChild("ArmBaseRight", CubeListBuilder.create().texOffs(36, 0).mirror(true).addBox(-1.5F, 0.0F, -2.0F, 3, 4, 3), PartPose.offsetAndRotation(-2.2F, 1.3F, 0.0F, 0.136659280431156F, 0.0F, 0.0F));
            PartDefinition ArmFurRight = ArmBaseRight.addOrReplaceChild("ArmFurRight", CubeListBuilder.create().texOffs(38, 20).mirror(true).addBox(-1.5F, -1.0F, 0.0F, 3, 5, 3), PartPose.offsetAndRotation(0.4F, 1.6F, -0.6F, 0.22759093446006054F, 0.0F, 0.0F));
            PartDefinition ArmRight = ArmBaseRight.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(38, 7).mirror(true).addBox(-1.0F, 0.0F, -2.0F, 2, 3, 2), PartPose.offsetAndRotation(0.0F, 3.8F, 0.5F, -0.045553093477052F, 0.0F, 0.0F));
            PartDefinition ForearmRight = ArmRight.addOrReplaceChild("ForearmRight", CubeListBuilder.create().texOffs(38, 12).mirror(true).addBox(-1.0F, 0.0F, 0.0F, 2, 2, 2), PartPose.offsetAndRotation(0.1F, 2.6F, -2.0F, -0.136659280431156F, 0.0F, 0.0F));
            PartDefinition HandRight = ForearmRight.addOrReplaceChild("HandRight", CubeListBuilder.create().texOffs(38, 16).mirror(true).addBox(-1.0F, -1.0F, -3.0F, 2, 2, 2), PartPose.offsetAndRotation(-0.1F, 2.0F, 2.4F, 0.091106186954104F, 0.0F, 0.0F));
            PartDefinition Neck = Chest.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(0, 37).addBox(-2.0F, -5.0F, -2.5F, 4, 6, 5), PartPose.offsetAndRotation(0.0F, -0.9F, -0.3F, 0.7285004297824331F, 0.0F, 0.0F));
            PartDefinition NeckFur2 = Neck.addOrReplaceChild("NeckFur2", CubeListBuilder.create().texOffs(41, 95).addBox(-1.5F, 0.0F, 0.0F, 3, 3, 3), PartPose.offsetAndRotation(0.0F, -0.5F, -5.0F, -0.4553564018453205F, 0.0F, 0.0F));
            PartDefinition NeckFurLeft = Neck.addOrReplaceChild("NeckFurLeft", CubeListBuilder.create().texOffs(32, 86).addBox(-1.5F, 0.0F, 0.0F, 3, 4, 4), PartPose.offsetAndRotation(0.4F, -4.2F, -3.2F, -0.5918411493512771F, 0.136659280431156F, 0.0F));
            PartDefinition NeckFurRight = Neck.addOrReplaceChild("NeckFurRight", CubeListBuilder.create().texOffs(47, 86).mirror(true).addBox(-1.5F, 0.0F, 0.0F, 3, 4, 4), PartPose.offsetAndRotation(-0.4F, -4.2F, -3.2F, -0.5918411493512771F, -0.136659280431156F, 0.0F));
            PartDefinition Collar = Neck.addOrReplaceChild("Collar", CubeListBuilder.create().texOffs(0, 63).addBox(-2.5F, 0.0F, -2.5F, 5, 1, 6), PartPose.offset(0.0F, -2.7F, -0.8F));
            PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 48).addBox(-2.5F, -2.5F, -2.5F, 5, 5, 5), PartPose.offsetAndRotation(0.0F, -5.2F, -0.2F, -0.5918411493512771F, 0.0F, 0.0F));
            PartDefinition FaceFurRight = Head.addOrReplaceChild("FaceFurRight", CubeListBuilder.create().texOffs(46, 79).mirror(true).addBox(-1.5F, 0.0F, -2.0F, 3, 3, 4), PartPose.offsetAndRotation(-1.6F, 0.4F, -0.9F, 0.136659280431156F, -0.18203784098300857F, 0.0F));
            PartDefinition EarLeft = Head.addOrReplaceChild("EarLeft", CubeListBuilder.create().texOffs(15, 48).addBox(-1.0F, -3.0F, 0.0F, 2, 4, 1), PartPose.offsetAndRotation(1.7F, -0.7F, 0.0F, 0.0F, -0.31869712141416456F, 0.22759093446006054F));
            PartDefinition EarFlapLeft = EarLeft.addOrReplaceChild("EarFlapLeft", CubeListBuilder.create().texOffs(20, 53).addBox(-1.0F, 0.0F, -2.0F, 2, 1, 2), PartPose.offsetAndRotation(0.0F, -3.0F, 1.0F, -0.27314402793711257F, 0.0F, 0.0F));
            PartDefinition EarRight = Head.addOrReplaceChild("EarRight", CubeListBuilder.create().texOffs(21, 48).mirror(true).addBox(-1.0F, -3.0F, 0.0F, 2, 4, 1), PartPose.offsetAndRotation(-1.7F, -0.7F, 0.0F, 0.0F, 0.31869712141416456F, -0.22759093446006054F));
            PartDefinition EarFlapRight = EarRight.addOrReplaceChild("EarFlapRight", CubeListBuilder.create().texOffs(28, 53).mirror(true).addBox(-1.0F, 0.0F, -2.0F, 2, 1, 2), PartPose.offsetAndRotation(0.0F, -3.0F, 1.0F, -0.27314402793711257F, 0.0F, 0.0F));
            PartDefinition Snout = Head.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(0, 58).addBox(-1.5F, 0.0F, -2.7F, 3, 2, 3), PartPose.offsetAndRotation(0.0F, 0.0F, -2.5F, -0.045553093477052F, 0.0F, 0.0F));
            PartDefinition TopSnout = Snout.addOrReplaceChild("TopSnout", CubeListBuilder.create().texOffs(12, 58).addBox(-1.0F, 0.0F, 0.0F, 2, 2, 3), PartPose.offsetAndRotation(0.0F, -0.3F, -3.0F, 0.18203784098300857F, 0.0F, 0.0F));
            PartDefinition Muzzle = Snout.addOrReplaceChild("Muzzle", CubeListBuilder.create().texOffs(0, 70).addBox(-2.0F, 0.0F, -3.3F, 4, 4, 4), PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.091106186954104F, 0.0F, 0.0F));
            PartDefinition Mouth = Snout.addOrReplaceChild("Mouth", CubeListBuilder.create().texOffs(22, 59).addBox(-1.0F, -1.0F, -2.5F, 2, 1, 3), PartPose.offset(0.0F, 2.4F, 0.0F));
            PartDefinition Tongue = Mouth.addOrReplaceChild("Tongue", CubeListBuilder.create().texOffs(-3, 49).addBox(-1.0F, 0.0F, -3.0F, 2, 0, 3), PartPose.offsetAndRotation(0.0F, -1.0F, 0.8F, -0.045553093477052F, 0.0F, 0.0F));
            PartDefinition FaceFurLeft = Head.addOrReplaceChild("FaceFurLeft", CubeListBuilder.create().texOffs(32, 79).addBox(-1.5F, 0.0F, -2.0F, 3, 3, 4), PartPose.offsetAndRotation(1.6F, 0.4F, -0.9F, 0.136659280431156F, 0.18203784098300857F, 0.0F));
            PartDefinition NeckLower = Neck.addOrReplaceChild("NeckLower", CubeListBuilder.create().texOffs(18, 40).addBox(-1.5F, 0.0F, 0.0F, 3, 6, 2), PartPose.offsetAndRotation(0.0F, -4.8F, -2.8F, -0.136659280431156F, 0.0F, 0.0F));
