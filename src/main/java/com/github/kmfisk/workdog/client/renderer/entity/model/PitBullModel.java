...
public abstract class PitBullModel extends WorkDogModel<PitBullEntity> {
    ...
    public static class Adult extends PitBullModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            partDefinition.addOrReplaceChild("Hips", CubeListBuilder.create().texOffs(0, 32).addBox(-4.0F, 0.0F, 0.0F, 8, 8, 4), PartPose.offsetAndRotation(0.0F, 0.0F, 9.0F, -0.18203784098300857F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(33, 9).addBox(-1.5F, 0.0F, -3.0F, 3, 3, 3), PartPose.offsetAndRotation(0.0F, 5.0F, 1.5F, -0.045553093477052F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("EarFlapRight", CubeListBuilder.create().texOffs(28, 58).mirror(true).addBox(-1.0F, 0.0F, -2.0F, 2, 1, 2), PartPose.offset(0.0F, -2.0F, 0.5F));
            partDefinition.addOrReplaceChild("UpperLegRight", CubeListBuilder.create().texOffs(50, 38).mirror(true).addBox(-1.5F, 0.0F, 0.0F, 3, 3, 4), PartPose.offsetAndRotation(0.0F, 6.0F, -2.0F, 0.27314402793711257F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ForearmRight", CubeListBuilder.create().texOffs(45, 15).mirror(true).addBox(-1.5F, 0.0F, 0.0F, 3, 2, 3), PartPose.offsetAndRotation(-0.01F, 2.6F, -3.0F, -0.091106186954104F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Mouth", CubeListBuilder.create().texOffs(0, 80).addBox(-1.5F, 0.0F, -2.4F, 3, 1, 3), PartPose.offsetAndRotation(0.0F, 2.6F, -1.5F, -0.136659280431156F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ArmBaseRight", CubeListBuilder.create().texOffs(46, 0).mirror(true).addBox(-2.0F, 0.0F, -2.0F, 4, 5, 4), PartPose.offsetAndRotation(-2.3F, 1.2F, -0.7F, 0.22759093446006054F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(36, 52).addBox(-1.5F, -1.0F, -3.2F, 3, 2, 3), PartPose.offsetAndRotation(-0.1F, 4.0F, -0.7F, 0.045553093477052F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Tongue", CubeListBuilder.create().texOffs(8, 74).addBox(-1.0F, 0.0F, -3.0F, 2, 0, 3), PartPose.offsetAndRotation(0.0F, 0.0F, 0.8F, -0.045553093477052F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Muzzle", CubeListBuilder.create().texOffs(38, 57).addBox(-2.5F, 0.0F, 0.0F, 5, 5, 4), PartPose.offset(0.0F, -0.8F, -5.1F));
            partDefinition.addOrReplaceChild("LowerLegRight", CubeListBuilder.create().texOffs(48, 45).mirror(true).addBox(-1.5F, 0.0F, -3.0F, 3, 4, 3), PartPose.offsetAndRotation(0.03F, 2.9F, 3.4F, -0.36425021489121656F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ArmBaseLeft", CubeListBuilder.create().texOffs(30, 0).addBox(-2.0F, 0.0F, -2.0F, 4, 5, 4), PartPose.offsetAndRotation(2.4F, 1.2F, -0.7F, 0.22759093446006054F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Saddlebag", CubeListBuilder.create().texOffs(24, 66).addBox(-4.5F, 0.0F, -3.0F, 9, 5, 6), PartPose.offset(0.0F, -0.7F, 7.9F));
            partDefinition.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(0, 91).addBox(-1.0F, -2.5F, 0.0F, 2, 2, 5), PartPose.offsetAndRotation(0.0F, 1.5F, 5.0F, 0.18203784098300857F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Collar", CubeListBuilder.create().texOffs(26, 77).addBox(-3.0F, 0.0F, -3.0F, 6, 1, 7), PartPose.offsetAndRotation(0.0F, -1.3F, -1.3F, 0.18203784098300857F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(28, 27).addBox(-2.0F, 0.0F, -2.5F, 4, 6, 5), PartPose.offsetAndRotation(2.9F, 2.9F, 0.9F, 0.31869712141416456F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 56).addBox(-3.0F, -3.0F, -3.0F, 6, 6, 5), PartPose.offsetAndRotation(0.0F, -3.5F, -0.6F, -0.5462880558742251F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(0, 84).addBox(-1.0F, -1.0F, 0.0F, 2, 2, 5), PartPose.offsetAndRotation(0.0F, 1.5F, 3.0F, -0.9560913642424937F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("HandLeft", CubeListBuilder.create().texOffs(33, 20).addBox(-1.5F, -0.7F, -3.4F, 3, 2, 3), PartPose.offset(0.1F, 1.9F, 2.6F));
            partDefinition.addOrReplaceChild("UpperLegLeft", CubeListBuilder.create().texOffs(36, 38).addBox(-1.5F, 0.0F, 0.0F, 3, 3, 4), PartPose.offsetAndRotation(0.0F, 6.0F, -2.0F, 0.27314402793711257F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("LowerLegLeft", CubeListBuilder.create().texOffs(36, 45).addBox(-1.5F, 0.0F, -3.0F, 3, 4, 3), PartPose.offsetAndRotation(-0.03F, 2.9F, 3.4F, -0.36425021489121656F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -4.5F, -3.0F, 8, 9, 6), PartPose.offsetAndRotation(0.0F, 12.1F, -4.7F, -0.091106186954104F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("SaddlebagLatchL", CubeListBuilder.create().texOffs(38, 58).addBox(0.0F, 0.0F, -0.5F, 1, 2, 1), PartPose.offset(4.0F, 0.5F, 0.0F));
            partDefinition.addOrReplaceChild("EarLeft", CubeListBuilder.create().texOffs(20, 54).addBox(-1.0F, -1.5F, -0.5F, 2, 3, 1), PartPose.offsetAndRotation(2.1F, -2.1F, 0.4F, 0.0F, -0.18203784098300857F, 0.18203784098300857F));
            partDefinition.addOrReplaceChild("ForearmLeft", CubeListBuilder.create().texOffs(33, 15).addBox(-1.5F, 0.0F, 0.0F, 3, 2, 3), PartPose.offsetAndRotation(-0.01F, 2.6F, -3.0F, -0.091106186954104F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("NeckLower", CubeListBuilder.create().texOffs(20, 42).addBox(-2.0F, 0.0F, -1.0F, 4, 8, 4), PartPose.offsetAndRotation(0.0F, -3.4F, -2.4F, -0.136659280431156F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(45, 9).mirror(true).addBox(-1.5F, 0.0F, -3.0F, 3, 3, 3), PartPose.offsetAndRotation(0.0F, 5.0F, 1.5F, -0.045553093477052F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("SaddlebagLatchR", CubeListBuilder.create().texOffs(38, 58).mirror(true).addBox(-1.0F, 0.0F, -0.5F, 1, 2, 1), PartPose.offset(-4.0F, 0.5F, 0.0F));
            partDefinition.addOrReplaceChild("EarFlapLeft", CubeListBuilder.create().texOffs(26, 55).addBox(-1.0F, 0.0F, -2.0F, 2, 1, 2), PartPose.offset(0.0F, -2.0F, 0.5F));
            partDefinition.addOrReplaceChild("TopSnout", CubeListBuilder.create().texOffs(0, 74).addBox(-1.5F, 0.0F, 0.0F, 3, 2, 4), PartPose.offsetAndRotation(0.0F, -0.1F, -4.7F, 0.18203784098300857F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("HandRight", CubeListBuilder.create().texOffs(45, 20).mirror(true).addBox(-1.5F, -0.7F, -3.4F, 3, 2, 3), PartPose.offset(-0.1F, 1.9F, 2.6F));
            partDefinition.addOrReplaceChild("EarRight", CubeListBuilder.create().texOffs(22, 58).mirror(true).addBox(-1.0F, -1.5F, -0.5F, 2, 3, 1), PartPose.offsetAndRotation(-2.1F, -2.1F, 0.4F, 0.0F, 0.18203784098300857F, -0.18203784098300857F));
            partDefinition.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(0, 44).addBox(-2.5F, -5.0F, -2.5F, 5, 7, 5), PartPose.offsetAndRotation(0.0F, -2.2F, -1.3F, 0.7285004297824331F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(0, 68).addBox(-2.0F, 0.0F, -4.4F, 4, 3, 3), PartPose.offset(0.0F, -0.7F, -1.4F));
            partDefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 15).addBox(-3.5F, 0.0F, 1.0F, 7, 9, 8), PartPose.offsetAndRotation(0.0F, -4.4F, 1.5F, 0.045553093477052F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ThighRight", CubeListBuilder.create().texOffs(46, 27).mirror(true).addBox(-2.0F, 0.0F, -2.5F, 4, 6, 5), PartPose.offsetAndRotation(-2.9F, 2.9F, 0.9F, 0.27314402793711257F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(48, 52).mirror(true).addBox(-1.5F, -1.0F, -3.2F, 3, 2, 3), PartPose.offsetAndRotation(0.1F, 4.0F, -0.7F, 0.045553093477052F, 0.0F, 0.0F));
...
//                this.Chest.y = MathHelper.cos(4.0F + (limbSwing * speed * 0.4F) + (float) Math.PI) * (degree * -0.3F) * limbSwingAmount * 0.5F;
    ...
    public static class Baby extends PitBullModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            partDefinition.addOrReplaceChild("EarRight", CubeListBuilder.create().texOffs(14, 12).mirror(true).addBox(-1.0F, -2.0F, 0.0F, 2, 2, 1), PartPose.offsetAndRotation(-1.1F, -0.6F, 0.4F, 0.136659280431156F, 0.091106186954104F, -0.31869712141416456F));
            ...
            partDefinition.addOrReplaceChild("UpperLegLeft", CubeListBuilder.create().texOffs(34, 7).addBox(-1.0F, 0.0F, 0.0F, 2, 2, 2), PartPose.offsetAndRotation(-0.1F, 4.0F, -1.1F, 0.4553564018453205F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(28, 25).addBox(-0.5F, 0.0F, 0.0F, 1, 1, 3), PartPose.offsetAndRotation(0.0F, 0.4F, 4.0F, -0.7285004297824331F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("UpperLegRight", CubeListBuilder.create().texOffs(45, 7).mirror(true).addBox(-1.0F, 0.0F, 0.0F, 2, 2, 2), PartPose.offsetAndRotation(0.1F, 4.0F, -1.1F, 0.4553564018453205F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(0, 25).addBox(-1.5F, 0.0F, -2.0F, 3, 2, 2), PartPose.offsetAndRotation(0.0F, 0.2F, -1.3F, 0.27314402793711257F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("EarLeft", CubeListBuilder.create().texOffs(10, 9).addBox(-1.0F, -2.0F, 0.0F, 2, 2, 1), PartPose.offsetAndRotation(1.0F, -0.6F, 0.4F, 0.136659280431156F, -0.091106186954104F, 0.31869712141416456F));
