...
public abstract class GermanShepherdModel extends WorkDogModel<GermanShepherdEntity> {
    ...
    public static class Adult extends GermanShepherdModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            partDefinition.addOrReplaceChild("Hips", CubeListBuilder.create().texOffs(0, 33).addBox(-4.0F, 0.0F, 0.0F, 8, 9, 5), PartPose.offsetAndRotation(0.0F, 0.0F, 10.0F, -0.18203784098300857F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("FaceFurLeft", CubeListBuilder.create().texOffs(0, 110).addBox(0.0F, 0.0F, 0.0F, 4, 4, 5), PartPose.offsetAndRotation(-0.7F, 0.0F, -3.4F, 0.0F, 0.136659280431156F, 0.0F));
            partDefinition.addOrReplaceChild("TailFur1", CubeListBuilder.create().texOffs(46, 106).addBox(-2.5F, 0.0F, -4.0F, 5, 6, 4), PartPose.offset(0.0F, 0.0F, -0.2F));
            partDefinition.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(52, 17).addBox(-1.5F, 0.0F, 0.0F, 3, 6, 3), PartPose.offsetAndRotation(0.0F, 5.0F, -2.0F, 0.27314402793711257F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("Tongue", CubeListBuilder.create().texOffs(46, 6).addBox(-1.0F, 0.0F, -4.0F, 2, 0, 4), PartPose.offsetAndRotation(0.0F, 0.0F, 0.5F, -0.045553093477052F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("TopSnout", CubeListBuilder.create().texOffs(48, 10).addBox(-1.5F, 0.0F, 0.0F, 3, 2, 5), PartPose.offsetAndRotation(0.0F, 0.0F, -3.8F, 0.136659280431156F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("NeckLower", CubeListBuilder.create().texOffs(20, 47).addBox(-2.0F, 0.0F, 0.0F, 4, 8, 3), PartPose.offsetAndRotation(0.0F, -4.2F, -3.7F, -0.31869712141416456F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(32, 38).addBox(-1.5F, 0.0F, -3.0F, 3, 4, 3), PartPose.offsetAndRotation(0.0F, 5.0F, 1.5F, -0.045553093477052F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("UpperLegLeft", CubeListBuilder.create().texOffs(0, 75).addBox(-2.0F, 0.0F, 0.0F, 4, 4, 4), PartPose.offsetAndRotation(0.0F, 7.0F, -2.4F, 0.5009094953223726F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Collar", CubeListBuilder.create().texOffs(32, 76).addBox(-3.0F, 0.0F, -3.5F, 6, 1, 8), PartPose.offset(0.0F, -1.3F, -1.6F));
            partDefinition.addOrReplaceChild("Muzzle", CubeListBuilder.create().texOffs(38, 57).addBox(-2.5F, 0.0F, 0.0F, 5, 5, 5), PartPose.offset(0.0F, -1.2F, -6.8F));
            partDefinition.addOrReplaceChild("ArmBaseRight", CubeListBuilder.create().texOffs(46, 29).mirror(true).addBox(-2.0F, 0.0F, -2.0F, 4, 5, 4), PartPose.offsetAndRotation(-2.4F, 1.3F, -0.1F, 0.24137903555081577F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(44, 38).mirror(true).addBox(-1.5F, 0.0F, -3.0F, 3, 4, 3), PartPose.offsetAndRotation(0.0F, 5.0F, 1.5F, -0.045553093477052F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(12, 91).mirror(true).addBox(-1.5F, -1.0F, -3.0F, 3, 2, 3), PartPose.offsetAndRotation(0.1F, 5.0F, -0.9F, 0.045553093477052F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("HandLeft", CubeListBuilder.create().texOffs(34, 51).addBox(-1.5F, -1.0F, -3.0F, 3, 2, 3), PartPose.offsetAndRotation(-0.1F, 3.0F, 2.4F, 0.091106186954104F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(0, 47).addBox(-2.5F, -5.0F, -2.5F, 5, 7, 5), PartPose.offsetAndRotation(0.0F, -2.6F, -0.9F, 1.0189232173142897F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("EarLeft", CubeListBuilder.create().texOffs(44, 0).addBox(-1.5F, -2.5F, 0.0F, 3, 4, 1), PartPose.offsetAndRotation(1.7F, -3.0F, 0.0F, 0.4553564018453205F, 0.091106186954104F, 0.22759093446006054F));
            partDefinition.addOrReplaceChild("FaceFurRight", CubeListBuilder.create().texOffs(18, 110).mirror(true).addBox(-4.0F, 0.0F, 0.0F, 4, 4, 5), PartPose.offsetAndRotation(0.7F, 0.0F, -3.4F, 0.0F, -0.136659280431156F, 0.0F));
            partDefinition.addOrReplaceChild("UpperLegRight", CubeListBuilder.create().texOffs(16, 75).mirror(true).addBox(-2.0F, 0.0F, 0.0F, 4, 4, 4), PartPose.offsetAndRotation(0.0F, 7.0F, -2.4F, 0.5462880558742251F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(24, 12).addBox(-2.0F, 0.0F, -3.5F, 4, 3, 4), PartPose.offsetAndRotation(0.1F, -0.8F, -3.0F, 0.136659280431156F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Saddlebag", CubeListBuilder.create().texOffs(24, 85).addBox(-4.5F, 0.0F, -3.0F, 9, 5, 6), PartPose.offset(0.0F, -0.7F, 9.9F));
            partDefinition.addOrReplaceChild("TailFur2", CubeListBuilder.create().texOffs(33, 114).addBox(-2.0F, 0.0F, 0.0F, 4, 8, 5), PartPose.offsetAndRotation(0.0F, 0.0F, -2.5F, 0.045553093477052F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("NeckFurLeft", CubeListBuilder.create().texOffs(21, 96).addBox(-1.5F, 0.0F, 0.0F, 3, 5, 4), PartPose.offsetAndRotation(1.3F, -4.7F, -3.7F, -0.7740535232594852F, 0.136659280431156F, 0.0F));
            partDefinition.addOrReplaceChild("Mouth", CubeListBuilder.create().texOffs(36, 12).addBox(-1.5F, 0.0F, -3.05F, 3, 1, 3), PartPose.offsetAndRotation(0.0F, 2.7F, 0.0F, -0.136659280431156F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("HandRight", CubeListBuilder.create().texOffs(46, 51).mirror(true).addBox(-1.5F, -1.0F, -3.0F, 3, 2, 3), PartPose.offsetAndRotation(0.1F, 3.0F, 2.4F, 0.091106186954104F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(0, 91).addBox(-1.5F, -1.0F, -3.0F, 3, 2, 3), PartPose.offsetAndRotation(-0.1F, 5.0F, -0.9F, 0.045553093477052F, 0.0F, 0.0F));
            ...
            partDefinition.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(40, 19).addBox(-1.5F, 0.0F, -2.0F, 3, 5, 3), PartPose.offsetAndRotation(0.0F, 1.5F, 4.5F, 1.2747884856566583F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("shape42", CubeListBuilder.create().texOffs(44, 67).addBox(-3.0F, 0.0F, 0.0F, 6, 3, 2), PartPose.offsetAndRotation(0.0F, -2.6F, 3.0F, -0.36425021489121656F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ForearmLeft", CubeListBuilder.create().texOffs(34, 45).addBox(-1.5F, 0.0F, 0.0F, 3, 3, 3), PartPose.offsetAndRotation(-0.1F, 3.5F, -3.0F, -0.136659280431156F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -4.0F, -2.5F, 8, 9, 5), PartPose.offsetAndRotation(0.0F, 10.1F, -5.7F, -0.09093165402890456F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(0, 63).addBox(-2.5F, 0.0F, -2.5F, 5, 7, 5), PartPose.offsetAndRotation(2.7F, 2.3F, 2.9F, 0.27314402793711257F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("NeckFur2", CubeListBuilder.create().texOffs(35, 96).addBox(-2.0F, 0.0F, 0.0F, 4, 6, 4), PartPose.offsetAndRotation(0.01F, -1.7F, -5.7F, -0.4553564018453205F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("NeckFurRight", CubeListBuilder.create().texOffs(21, 96).mirror(true).addBox(-1.5F, 0.0F, 0.0F, 3, 5, 4), PartPose.offsetAndRotation(-1.3F, -4.7F, -3.7F, -0.7740535232594852F, -0.136659280431156F, 0.0F));
            partDefinition.addOrReplaceChild("EarRight", CubeListBuilder.create().texOffs(52, 0).mirror(true).addBox(-1.5F, -2.5F, 0.0F, 3, 4, 1), PartPose.offsetAndRotation(-1.7F, -3.0F, 0.0F, 0.5009094953223726F, 0.091106186954104F, -0.22759093446006054F));
            partDefinition.addOrReplaceChild("ThighRight", CubeListBuilder.create().texOffs(20, 63).mirror(true).addBox(-2.5F, 0.0F, -2.5F, 5, 7, 5), PartPose.offsetAndRotation(-2.7F, 2.3F, 2.9F, 0.27314402793711257F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("LowerLegLeft", CubeListBuilder.create().texOffs(0, 83).addBox(-1.5F, 0.0F, -3.0F, 3, 5, 3), PartPose.offsetAndRotation(0.0F, 4.0F, 3.5F, -0.6373942428283291F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 14).addBox(-3.5F, 0.0F, 0.0F, 7, 9, 10), PartPose.offsetAndRotation(0.0F, -4.0F, 2.0F, 0.045553093477052F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("LowerLegRight", CubeListBuilder.create().texOffs(12, 83).mirror(true).addBox(-1.5F, 0.0F, -3.0F, 3, 5, 3), PartPose.offsetAndRotation(0.0F, 4.0F, 3.5F, -0.6373942428283291F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ForearmRight", CubeListBuilder.create().texOffs(46, 45).mirror(true).addBox(-1.5F, 0.0F, 0.0F, 3, 3, 3), PartPose.offsetAndRotation(0.1F, 3.5F, -3.0F, -0.136659280431156F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("ArmBaseLeft", CubeListBuilder.create().texOffs(30, 29).addBox(-2.0F, 0.0F, -2.0F, 4, 5, 4), PartPose.offsetAndRotation(2.4F, 1.3F, -0.1F, 0.20996310901491783F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("BellyFur", CubeListBuilder.create().texOffs(0, 96).addBox(-2.5F, 0.0F, 0.0F, 5, 3, 11), PartPose.offsetAndRotation(0.0F, 8.7F, -0.5F, 0.18203784098300857F, 0.0F, 0.0F));
            partDefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(26, 0).addBox(-3.0F, -3.0F, -3.0F, 6, 6, 6), PartPose.offsetAndRotation(0.0F, -4.2F, -0.9F, -0.7742280561846846F, 0.0F, 0.0F));
