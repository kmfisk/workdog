...
public abstract class AkitaModel extends WorkDogModel<AkitaEntity> {
    ...
    public static ModelLayerLocation EQUIPMENT_LAYER = new ModelLayerLocation(new ResourceLocation(WorkDog.MOD_ID, "akita"), "equipment");
    ...
    public static class Adult extends AkitaModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Chest = partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 0).addBox(-4.0F, -4.0F, -2.5F, 8, 9, 5), PartPose.offsetAndRotation(0.0F, 10.2F, -5.7F, -0.045553093477052F, 0.0F, 0.0F));
            PartDefinition ArmBaseRight = Chest.addOrReplaceChild("ArmBaseRight", CubeListBuilder.create().texOffs(46, 28).mirror(true).addBox(-2.0F, 0.0F, -2.0F, 4, 5, 4), PartPose.offsetAndRotation(-2.4F, 1.3F, -0.1F, 0.136659280431156F, 0.0F, 0.0F));
            PartDefinition ArmRight = ArmBaseRight.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(44, 37).mirror(true).addBox(-1.5F, 0.0F, -3.0F, 3, 4, 3), PartPose.offsetAndRotation(0.0F, 5.0F, 1.5F, -0.045553093477052F, 0.0F, 0.0F));
            PartDefinition Body = Chest.addOrReplaceChild("Body", CubeListBuilder.create().texOffs(0, 14).addBox(-3.5F, 0.0F, 0.0F, 7, 9, 9), PartPose.offsetAndRotation(0.0F, -4.0F, 2.0F, 0.045553093477052F, 0.0F, 0.0F));
            PartDefinition Hips = Body.addOrReplaceChild("Hips", CubeListBuilder.create().texOffs(0, 32).addBox(-4.0F, 0.0F, 0.0F, 8, 9, 5), PartPose.offsetAndRotation(0.0F, 0.0F, 9.0F, -0.18203784098300857F, 0.0F, 0.0F));
            PartDefinition Tail1 = Hips.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(23, 12).addBox(-1.5F, -1.0F, -1.0F, 3, 3, 3), PartPose.offsetAndRotation(0.0F, 3.0F, 5.0F, 1.1383037381507017F, 0.0F, 0.0F));
            PartDefinition Neck = Chest.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(0, 46).addBox(-2.5F, -5.0F, -2.5F, 5, 7, 5), PartPose.offsetAndRotation(0.0F, -2.2F, -0.3F, 0.6829473363053812F, 0.0F, 0.0F));
            PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(26, 0).addBox(-3.0F, -3.0F, -3.0F, 6, 6, 6), PartPose.offsetAndRotation(0.0F, -4.2F, -0.9F, -0.5918411493512771F, 0.0F, 0.0F));
            PartDefinition EarLeft = Head.addOrReplaceChild("EarLeft", CubeListBuilder.create().texOffs(58, 0).addBox(-1.0F, -2.0F, 0.0F, 2, 3, 1), PartPose.offsetAndRotation(2.0F, -3.0F, 0.0F, 0.4553564018453205F, 0.091106186954104F, 0.22759093446006054F));
            PartDefinition ArmBaseLeft = Chest.addOrReplaceChild("ArmBaseLeft", CubeListBuilder.create().texOffs(30, 28).addBox(-2.0F, 0.0F, -2.0F, 4, 5, 4), PartPose.offsetAndRotation(2.4F, 1.3F, -0.1F, 0.136659280431156F, 0.0F, 0.0F));
            PartDefinition ArmLeft = ArmBaseLeft.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(32, 37).addBox(-1.5F, 0.0F, -3.0F, 3, 4, 3), PartPose.offsetAndRotation(0.0F, 5.0F, 1.5F, -0.045553093477052F, 0.0F, 0.0F));
            PartDefinition ForearmLeft = ArmLeft.addOrReplaceChild("ForearmLeft", CubeListBuilder.create().texOffs(34, 44).addBox(-1.5F, 0.0F, 0.0F, 3, 3, 3), PartPose.offsetAndRotation(-0.1F, 3.5F, -3.0F, -0.136659280431156F, 0.0F, 0.0F));
            PartDefinition Snout = Head.addOrReplaceChild("Snout", CubeListBuilder.create().texOffs(44, 0).addBox(-2.0F, 0.0F, -2.8F, 4, 3, 3), PartPose.offsetAndRotation(0.0F, -0.6F, -3.0F, -0.045553093477052F, 0.0F, 0.0F));
            ...
            PartDefinition EarRight = Head.addOrReplaceChild("EarRight", CubeListBuilder.create().texOffs(58, 4).mirror(true).addBox(-1.0F, -2.0F, 0.0F, 2, 3, 1), PartPose.offsetAndRotation(-2.0F, -3.0F, 0.0F, 0.5009094953223726F, 0.091106186954104F, -0.22759093446006054F));
            PartDefinition ThighRight = Hips.addOrReplaceChild("ThighRight", CubeListBuilder.create().texOffs(22, 63).mirror(true).addBox(-2.5F, 0.0F, -3.0F, 5, 7, 6), PartPose.offsetAndRotation(-2.7F, 3.0F, 1.9F, 0.27314402793711257F, 0.0F, 0.0F));
            PartDefinition UpperLegRight = ThighRight.addOrReplaceChild("UpperLegRight", CubeListBuilder.create().texOffs(16, 76).mirror(true).addBox(-2.0F, 0.0F, 0.0F, 4, 4, 4), PartPose.offsetAndRotation(0.0F, 7.0F, -2.4F, 0.5462880558742251F, 0.0F, 0.0F));
            PartDefinition LowerLegRight = UpperLegRight.addOrReplaceChild("LowerLegRight", CubeListBuilder.create().texOffs(12, 84).mirror(true).addBox(-1.5F, 0.0F, -3.0F, 3, 5, 3), PartPose.offsetAndRotation(0.0F, 4.0F, 3.5F, -0.6373942428283291F, 0.0F, 0.0F));
            PartDefinition FootRight = LowerLegRight.addOrReplaceChild("FootRight", CubeListBuilder.create().texOffs(12, 92).mirror(true).addBox(-1.5F, -1.0F, -3.0F, 3, 2, 3), PartPose.offset(0.1F, 5.0F, -0.9F));
            PartDefinition Collar = Neck.addOrReplaceChild("Collar", CubeListBuilder.create().texOffs(32, 76).addBox(-3.0F, 0.0F, -3.0F, 6, 1, 7), PartPose.offsetAndRotation(0.0F, -1.3F, -1.5F, 0.091106186954104F, 0.0F, 0.0F));
            PartDefinition NeckLower = Neck.addOrReplaceChild("NeckLower", CubeListBuilder.create().texOffs(20, 46).addBox(-2.0F, 0.0F, 0.0F, 4, 8, 3), PartPose.offsetAndRotation(0.0F, -4.2F, -3.1F, -0.31869712141416456F, 0.0F, 0.0F));
            PartDefinition ThighLeft = Hips.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(0, 63).addBox(-2.5F, 0.0F, -3.0F, 5, 7, 6), PartPose.offsetAndRotation(2.7F, 3.0F, 1.9F, 0.27314402793711257F, 0.0F, 0.0F));
            PartDefinition Saddlebag = Body.addOrReplaceChild("Saddlebag", CubeListBuilder.create().texOffs(24, 84).addBox(-4.5F, 0.0F, -3.0F, 9, 5, 6), PartPose.offset(0.0F, -0.7F, 7.9F));
            ...
            PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(35, 12).addBox(-1.5F, 0.0F, 0.0F, 3, 4, 3), PartPose.offsetAndRotation(0.0F, 2.0F, -1.0F, 0.7740535232594852F, -0.008726646259971648F, 0.0F));
            PartDefinition Tail3 = Tail2.addOrReplaceChild("Tail3", CubeListBuilder.create().texOffs(32, 19).addBox(-1.5F, 0.0F, 0.0F, 3, 4, 3), PartPose.offsetAndRotation(0.0F, 4.0F, 0.0F, 1.1838568316277536F, 0.22759093446006054F, 0.0F));
            PartDefinition Tail4 = Tail3.addOrReplaceChild("Tail4", CubeListBuilder.create().texOffs(44, 19).addBox(-1.5F, 0.0F, 0.0F, 3, 4, 3), PartPose.offsetAndRotation(0.0F, 4.0F, 0.0F, 1.0471975511965976F, 0.017453292519943295F, 0.18203784098300857F));
            PartDefinition UpperLegLeft = ThighLeft.addOrReplaceChild("UpperLegLeft", CubeListBuilder.create().texOffs(0, 76).addBox(-2.0F, 0.0F, 0.0F, 4, 4, 4), PartPose.offsetAndRotation(0.0F, 7.0F, -2.4F, 0.5009094953223726F, 0.0F, 0.0F));
            PartDefinition LowerLegLeft = UpperLegLeft.addOrReplaceChild("LowerLegLeft", CubeListBuilder.create().texOffs(0, 84).addBox(-1.5F, 0.0F, -3.0F, 3, 5, 3), PartPose.offsetAndRotation(0.0F, 4.0F, 3.5F, -0.6373942428283291F, 0.0F, 0.0F));
            PartDefinition Muzzle = Head.addOrReplaceChild("Muzzle", CubeListBuilder.create().texOffs(38, 57).addBox(-2.5F, 0.0F, 0.0F, 5, 5, 5), PartPose.offset(0.0F, -1.0F, -6.6F));
            ...
            PartDefinition Mouth = Snout.addOrReplaceChild("Mouth", CubeListBuilder.create().texOffs(52, 14).addBox(-1.5F, 0.0F, -2.45F, 3, 1, 3), PartPose.offsetAndRotation(0.0F, 2.8F, 0.0F, -0.22759093446006054F, 0.0F, 0.0F));
            ...
            PartDefinition ForearmRight = ArmRight.addOrReplaceChild("ForearmRight", CubeListBuilder.create().texOffs(46, 44).mirror(true).addBox(-1.5F, 0.0F, 0.0F, 3, 3, 3), PartPose.offsetAndRotation(0.1F, 3.5F, -3.0F, -0.136659280431156F, 0.0F, 0.0F));
            PartDefinition HandRight = ForearmRight.addOrReplaceChild("HandRight", CubeListBuilder.create().texOffs(46, 50).mirror(true).addBox(-1.5F, -1.0F, -3.0F, 3, 2, 3), PartPose.offsetAndRotation(0.1F, 3.0F, 2.4F, 0.091106186954104F, 0.0F, 0.0F));
            PartDefinition HandLeft = ForearmLeft.addOrReplaceChild("HandLeft", CubeListBuilder.create().texOffs(34, 50).addBox(-1.5F, -1.0F, -3.0F, 3, 2, 3), PartPose.offsetAndRotation(-0.1F, 3.0F, 2.4F, 0.091106186954104F, 0.0F, 0.0F));
            ...
            PartDefinition FootLeft = LowerLegLeft.addOrReplaceChild("FootLeft", CubeListBuilder.create().texOffs(0, 92).addBox(-1.5F, -1.0F, -3.0F, 3, 2, 3), PartPose.offset(-0.1F, 5.0F, -0.9F));
...
//                this.Chest.y = MathHelper.cos(4.0F + (limbSwing * speed * 0.4F) + (float) Math.PI) * (degree * -0.3F) * limbSwingAmount * 0.5F;
    ...
    public static class Baby extends AkitaModel {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            PartDefinition Chest = partDefinition.addOrReplaceChild("Chest", CubeListBuilder.create().texOffs(0, 0).addBox(-2.5F, -2.5F, -2.0F, 5, 5, 4), PartPose.offsetAndRotation(0.0F, 19.1F, -2.0F, -0.045553093477052F, 0.0F, 0.0F));
            PartDefinition Neck = Chest.addOrReplaceChild("Neck", CubeListBuilder.create().texOffs(0, 9).addBox(-1.5F, -2.7F, -2.1F, 3, 4, 4), PartPose.offsetAndRotation(0.0F, -1.3F, -0.7F, 0.6829473363053812F, 0.0F, 0.0F));
            ...
            PartDefinition Head = Neck.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(0, 17).addBox(-2.0F, -2.0F, -2.0F, 4, 4, 4), PartPose.offsetAndRotation(0.0F, -2.1F, -0.2F, -0.5918411493512771F, 0.0F, 0.0F));
            PartDefinition ThighRight = Body.addOrReplaceChild("ThighRight", CubeListBuilder.create().texOffs(44, 0).mirror(true).addBox(-1.0F, 0.0F, -1.5F, 2, 4, 3), PartPose.offset(-1.7F, 1.3F, 3.0F));
            ...
            PartDefinition ArmRight = Chest.addOrReplaceChild("ArmRight", CubeListBuilder.create().texOffs(32, 15).mirror(true).addBox(-1.0F, 0.0F, -1.0F, 2, 3, 2), PartPose.offsetAndRotation(-1.7F, 1.0F, -0.5F, 0.136659280431156F, 0.0F, 0.0F));
            ...
            PartDefinition Mouth = Snout.addOrReplaceChild("Mouth", CubeListBuilder.create().texOffs(10, 25).addBox(-1.0F, -1.0F, -2.0F, 2, 1, 2), PartPose.offsetAndRotation(0.0F, 2.3F, 0.2F, -0.045553093477052F, 0.0F, 0.0F));
            PartDefinition ThighLeft = Body.addOrReplaceChild("ThighLeft", CubeListBuilder.create().texOffs(34, 0).addBox(-1.0F, 0.0F, -1.5F, 2, 4, 3), PartPose.offset(1.7F, 1.3F, 3.0F));
            ...
            PartDefinition ArmLeft = Chest.addOrReplaceChild("ArmLeft", CubeListBuilder.create().texOffs(24, 15).addBox(-1.0F, 0.0F, -1.0F, 2, 3, 2), PartPose.offsetAndRotation(1.7F, 1.0F, -0.5F, 0.136659280431156F, 0.0F, 0.0F));
            ...
            PartDefinition Tail1 = Body.addOrReplaceChild("Tail1", CubeListBuilder.create().texOffs(14, 15).addBox(-1.0F, -2.0F, -2.0F, 2, 2, 2), PartPose.offsetAndRotation(0.0F, 2.0F, 4.0F, -0.8196066167365371F, 0.0F, 0.0F));
            PartDefinition Tail2 = Tail1.addOrReplaceChild("Tail2", CubeListBuilder.create().texOffs(16, 19).addBox(-1.0F, 0.0F, 0.0F, 2, 1, 2), PartPose.offsetAndRotation(0.02F, -2.0F, -1.9F, -1.3203415791337103F, 0.0F, 0.0F));
            PartDefinition Tail3 = Tail2.addOrReplaceChild("Tail3", CubeListBuilder.create().texOffs(16, 22).addBox(-1.0F, -1.0F, 0.0F, 2, 1, 2), PartPose.offsetAndRotation(0.02F, 1.0F, 0.0F, -0.5462880558742251F, 0.0F, 0.0F));
            ...
            PartDefinition EarLeft = Head.addOrReplaceChild("EarLeft", CubeListBuilder.create().texOffs(10, 9).addBox(-1.0F, -2.0F, 0.0F, 2, 2, 1), PartPose.offsetAndRotation(1.1F, -0.2F, 0.4F, 0.136659280431156F, -0.091106186954104F, 0.31869712141416456F));
